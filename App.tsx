...
// Reports
import YoungChildReport from './components/reports/YoungChildReport';
import AdultReport from './components/reports/AdultReport';
import ChildReport from './components/reports/ChildReport';
...
const StepRenderer: React.FC = () => {
  ...
  switch (currentStepId) {
    ...
    case 'YOUNG_CHILD_PRINT_REPORT':
        return <YoungChildReport />;
