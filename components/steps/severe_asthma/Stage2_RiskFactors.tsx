...
const Stage2_RiskFactors: React.FC = () => {
    ...
    return (
        <div>
            <AssessmentCard title="Évaluation des Comorbidités" icon={<FileText />}>
            ...
            <AssessmentCard title="Facteurs de Risque et Déclencheurs" icon={<AlertTriangle />}>
            ...
            <div className="mt-6 border-t border-slate-300 pt-6">
                 ...
                 >
                    Procéder à l'Optimisation de la Prise en Charge
                </Button>
            </div>
        </div>
    );
