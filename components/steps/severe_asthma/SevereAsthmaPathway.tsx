...
const stages = [
    { id: 1, stepId: 'SEVERE_ASTHMA_STAGE_1', title: "Évaluation du Patient", color: "bg-green-500" },
    { id: 2, stepId: 'SEVERE_ASTHMA_STAGE_2', title: "Facteurs de Risque", color: "bg-green-500" },
    { id: 3, stepId: 'SEVERE_ASTHMA_STAGE_3', title: "Optimiser la Prise en Charge", color: "bg-green-500" },
    { id: 4, stepId: 'SEVERE_ASTHMA_STAGE_4', title: "Réévaluer la Réponse", color: "bg-green-500" },
    { id: 5, stepId: 'SEVERE_ASTHMA_STAGE_5', title: "Évaluation Spécialisée", color: "bg-blue-500" },
    { id: 6, stepId: 'SEVERE_ASTHMA_STAGE_6', title: "Évaluation du Phénotype", color: "bg-blue-500" },
    { id: 7, stepId: 'SEVERE_ASTHMA_STAGE_7', title: "Options Thérapeutiques", color: "bg-blue-500" },
    { id: 8, stepId: 'SEVERE_ASTHMA_STAGE_8', title: "Thérapie Biologique", color: "bg-blue-500" },
    { id: 9, stepId: 'SEVERE_ASTHMA_STAGE_9', title: "Suivi de la Réponse", color: "bg-amber-600" },
    { id: 10, stepId: 'SEVERE_ASTHMA_STAGE_10', title: "Soins Continus", color: "bg-amber-600" },
    { id: 11, stepId: 'SEVERE_ASTHMA_STAGE_11', title: "Rapport de Synthèse", color: "bg-slate-600" }
];
...
const StageHeader: React.FC<{ stage: any, isActive: boolean, onClick: () => void }> = ({ stage, isActive, onClick }) => (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="font-semibold text-sm">Étape {stage.id}: {stage.title}</span>
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <header className="bg-white rounded-lg shadow-md p-6 mb-6 text-center">
                <h1 className="text-3xl font-bold text-red-800 mb-2">Système de Prise en Charge de l'Asthme Sévère</h1>
                <p className="text-gray-600">Un outil d'aide à la décision clinique basé sur le GINA pour l'asthme difficile à traiter et sévère</p>
            </header>

            <div className="flex flex-col lg:flex-row gap-6">
                <div className="w-full lg:w-80 flex-shrink-0">
                    <div className="bg-white rounded-lg shadow-md p-4 sticky top-6">
                        <h2 className="text-lg font-semibold mb-4 text-center">Étapes de Prise en Charge</h2>
