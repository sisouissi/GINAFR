...
const AdultExacerbationSeverityStep: React.FC = () => {
  ...
  return (
    <Card title="Évaluer la Gravité de l'Exacerbation (Adultes & Adolescents)" icon={<ShieldAlert className="text-red-600" />}>
      <p className="mb-6 text-sm text-slate-600 leading-relaxed">
        Évaluez les symptômes et les signes du patient pour classifier la gravité de l'exacerbation.
        Cela guidera le plan de prise en charge immédiat (basé sur GINA 2025, Encadré 9-4).
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <SeverityOptionCard
          ...
          criteria={[
            "Parle en phrases",
            "Préfère être assis plutôt qu'allongé",
            "Non agité",
            "Fréquence respiratoire augmentée",
            "Muscles accessoires non utilisés",
            "Pouls 100-120 bpm",
            "SaO2 (à l'air ambiant) 90-95%",
            "DEP > 50% de la valeur prédite ou de la meilleure valeur personnelle",
          ]}
        ...
        <SeverityOptionCard
          ...
          criteria={[
            ...
            "DEP <= 50% de la valeur prédite ou de la meilleure valeur personnelle",
            "Signes de mise en jeu du pronostic vital : Somnolence, confusion, silence auscultatoire.",
          ]}
      ...
      <div className="mt-8 p-4 bg-slate-100 border border-slate-200 rounded-lg text-sm">
        <div className="flex items-start">
          ...
          <p className="text-slate-600 leading-relaxed">
            <strong>Toujours considérer les signes de mise en jeu du pronostic vital :</strong> La somnolence, la confusion, ou un silence auscultatoire indiquent une exacerbation nécessitant une intervention médicale d'urgence immédiate, quels que soient les autres signes.
          </p>
        </div>
      </div>
    </Card>
