...
const AdultExacerbationIntroStep: React.FC = () => {
  ...
  return (
    <Card title="Gestion des Exacerbations d'Asthme (Adultes)" icon={<Zap className="text-red-600"/>}>
      ...
      <p className="mb-6 text-sm text-slate-600">
        Une reconnaissance et une gestion rapides sont essentielles pour prévenir des conséquences graves.
        Cette section vous guidera dans l'évaluation de la gravité et les actions appropriées basées sur les recommandations du GINA.
      </p>
      ...
      <div className="mb-6 p-4 bg-sky-50 border border-sky-200 rounded-lg">
        <div className="flex items-start">
          ...
          <div>
            <h3 className="text-md font-semibold text-sky-800">Principes Clés de la Prise en Charge :</h3>
            <ul className="list-disc list-inside text-sm text-slate-600 mt-2 space-y-1">
              <li>Évaluer rapidement la gravité de l'exacerbation.</li>
              <li>Instaurer rapidement un traitement de secours approprié.</li>
      ...
      <p className="mb-6 text-center font-medium text-slate-700">
        Commençons par déterminer la gravité de l'exacerbation actuelle.
      </p>
