      ...
      <div className="mt-8 pt-6 border-t border-slate-300">
        <div className="p-4 bg-slate-100 rounded-lg border border-slate-200">
            ...
            <p className="text-sm text-slate-600 mb-3">
                Une exacerbation d'asthme est un échec de la prise en charge chronique et signale un risque accru de futures crises. Une consultation de suivi urgente est essentielle.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-slate-600 mt-2 pl-4">
                ...
                <li>Revoir et ajuster le traitement de fond continu du patient.</li>
                <li>Évaluer si une orientation vers un spécialiste est nécessaire pour la prise en charge de l'asthme sévère.</li>
            </ul>
        </div>
      </div>
