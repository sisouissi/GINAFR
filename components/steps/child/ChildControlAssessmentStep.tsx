...
const questions: ControlQuestion[] = [
  ...
  },
  {
    ...
    questionText: 'Au cours des 4 dernières semaines, l\'enfant a-t-il eu une limitation de son activité due à l\'asthme ?',
    options: [{ label: 'Oui', value: 1 }, { label: 'Non', value: 0 }],
  },
  {
    id: 'nocturnalSymptoms',
    questionText: 'Au cours des 4 dernières semaines, l\'enfant a-t-il eu des réveils nocturnes dus à l\'asthme ?',
    options: [{ label: 'Oui', value: 1 }, { label: 'Non', value: 0 }],
  },
  {
    id: 'relieverNeed',
    questionText: 'Au cours des 4 dernières semaines, l\'enfant a-t-il eu besoin de son SABA de secours pour des symptômes plus de deux fois par semaine ?',
    options: [{ label: 'Oui', value: 1 }, { label: 'Non', value: 0 }],
  },
];
...
const ChildControlAssessmentStep: React.FC = () => {
  ...
  return (
    <Card title="Évaluation du Contrôle de l'Asthme (Enfant 6-11 ans)" icon={<ListChecks className="text-emerald-600" />}>
      <p className="mb-1 text-sm text-slate-600">
        Basé sur le rapport des parents/soignants et de l'enfant pour les <strong>4 dernières semaines</strong>, évaluez le niveau de contrôle des symptômes (GINA 2025, Encadré 2-2A).
      </p>
