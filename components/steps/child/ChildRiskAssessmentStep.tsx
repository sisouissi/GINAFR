...
const ChildRiskAssessmentStep: React.FC = () => {
  ...
  return (
    <Card title="Évaluer les Facteurs de Risque d'Exacerbations (Enfants 6-11 ans)" icon={<AlertTriangle className="text-amber-600" />}>
      <p className="mb-6 text-sm text-slate-600 leading-relaxed">
        Identifiez tout facteur de risque modifiable pour les exacerbations futures, ce qui est essentiel pour une prise en charge complète de l'asthme chez les enfants (GINA Encadrés 2-2B et 2-3).
      </p>
      ...
      <div className="mt-8">
        <Button onClick={handleContinue} fullWidth size="xl" rightIcon={<ChevronRight />} variant="success">
          Continuer vers l'Évaluation Initiale
        </Button>
      </div>
    </Card>
  );
