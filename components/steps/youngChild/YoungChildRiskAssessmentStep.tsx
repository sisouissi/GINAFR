...
const YoungChildRiskAssessmentStep: React.FC = () => {
  ...
  return (
    <Card title="Évaluer les Facteurs de Risque (Enfant ≤5 ans)" icon={<Baby className="text-violet-600" />}>
      <p className="mb-6 text-sm text-slate-600 leading-relaxed">
        Identifiez les facteurs de risque qui peuvent augmenter la probabilité de futures exacerbations chez les jeunes enfants. Ceci est une partie clé de l'évaluation initiale.
      </p>
      ...
      <div className="mt-8">
        <Button onClick={handleContinue} fullWidth size="xl" rightIcon={<ChevronRight />} variant="violet">
          Continuer vers la Sélection du Schéma des Symptômes
        </Button>
      </div>
    </Card>
  );
