        ...
        >
            <header className="flex items-center justify-between p-4 bg-slate-900 text-white rounded-t-lg border-b border-slate-700">
                <div className="flex items-center">
                    ...
                    <div>
                        <h2 className="text-lg font-semibold">Demandez à l'expert</h2>
                        <p className="text-xs text-slate-400">Votre guide pour le document GINA 2025</p>
                    </div>
                </div>
                <Button variant="ghost" onClick={closeAIPanel} size="sm" className="!p-2 text-white hover:bg-slate-700" aria-label="Fermer le panneau">
                    <XCircle size={20} />
                </Button>
            </header>
            ...
            <div className="flex-grow p-4 overflow-y-auto space-y-4">
                ...
                {error && (
                     <div className="p-3 rounded-lg bg-red-100 text-red-700 border border-red-200 text-sm">
                        Erreur de communication avec le service IA. Veuillez réessayer. Détails : {error}
                    </div>
                )}
            ...
            <footer className="p-4 border-t border-slate-200 bg-white rounded-b-lg">
                <form onSubmit={handleSubmit} className="flex items-center gap-2">
                    <input
                        ...
                        placeholder="Posez une question sur le guide GINA..."
